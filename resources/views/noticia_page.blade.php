            ...
            <div class="row">
                <div class="col-6">
                    ...
                    @if(isset($noticia->img_noticia))
                        <img src="{{ asset($noticia->img_noticia) }}" alt="Imagen 1" class="shadow p-2 mb-2 rounded" style="width: 600px">
                    @else
                        <img src="https://picsum.photos/300/200?random=2" alt="Imagen 1" class="shadow p-2 mb-2 rounded" style="width: 600px">
                    @endif
                    <div class="mb-2">
                        <p>Subido el {{ $noticia->created_at }}</p>
                        Subido por: {{$noticia->autor}}
                    </div>
                </div>
                <div class="col-6">
                    <h5>Contenido:</h5>
